...
import FileUpLoader from "@/client/components/form/file-upload-cloudnary";
import { LoadingButton } from "@/client/components/loading/loading-button";
...
const registerSchema = object({
  ...
  photo: string().min(1, "Photo is required").optional(),
  password: string()
        ...
        <FormProvider {...methods}>
          ...
          >
            ...
            <span className="block">
              ...
              <Link href="/login">
                <span className="text-ct-blue-600">Login Here</span>
              </Link>
            </span>
